...
void executeRoomba(RoombaCommand command)
{
  switch (command) {
    case RoombaCommand::FORWARD: 
      roomba.drive(500, 0x8000);
      break;
    case RoombaCommand::REVERSE: 
      roomba.drive(-500, 0x8000);
      break;
    case RoombaCommand::FORWARDLEFT: 
      roomba.drive(500, 200);
      break;
    case RoombaCommand::FORWARDRIGHT: 
      roomba.drive(500, -200);
      break;
    case RoombaCommand::TURNLEFT: 
      roomba.drive(500, 1);
      break;
    case RoombaCommand::TURNRIGHT: 
      roomba.drive(500, -1);
      break;
...
void initWeb() {
    ...
    // Roomba handlers
    web.on("/roomba_fwd", HTTP_GET, [](AsyncWebServerRequest *request) {
        AsyncResponseStream *response = request->beginResponseStream("text/plain");

        LOG_PORT.println("Driving roomba forward.");
        executeRoomba(RoombaCommand::FORWARD);
        LOG_PORT.println("Finished driving roomba forward.");
    ...
    // Roomba handlers
    web.on("/roomba_turnleft", HTTP_GET, [](AsyncWebServerRequest *request) {
        AsyncResponseStream *response = request->beginResponseStream("text/plain");

        LOG_PORT.println("Driving roomba turn-left.");
        executeRoomba(RoombaCommand::TURNLEFT);
        LOG_PORT.println("Finished driving roomba turn-left.");
    ...
    // Roomba handlers
    web.on("/roomba_turnright", HTTP_GET, [](AsyncWebServerRequest *request) {
        AsyncResponseStream *response = request->beginResponseStream("text/plain");

        LOG_PORT.println("Driving roomba turn-right.");
        executeRoomba(RoombaCommand::TURNRIGHT);
        LOG_PORT.println("Finished driving roomba turn-right.");
    ...
    // Roomba handlers
    web.on("/roomba_reverse", HTTP_GET, [](AsyncWebServerRequest *request) {
        AsyncResponseStream *response = request->beginResponseStream("text/plain");

        LOG_PORT.println("Driving roomba reverse.");
        executeRoomba(RoombaCommand::REVERSE);
        LOG_PORT.println("Finished driving roomba reverse.");
    ...
    // Roomba handlers
    web.on("/roomba_stop", HTTP_GET, [](AsyncWebServerRequest *request) {
        AsyncResponseStream *response = request->beginResponseStream("text/plain");
    ...
    // Roomba handlers
    web.on("/roomba_fwdleft", HTTP_GET, [](AsyncWebServerRequest *request) {
        AsyncResponseStream *response = request->beginResponseStream("text/plain");

        LOG_PORT.println("Driving roomba forward-left.");
        executeRoomba(RoombaCommand::FORWARDLEFT);
        LOG_PORT.println("Finished driving roomba forward-left.");
    ...
    // Roomba handlers
    web.on("/roomba_fwdright", HTTP_GET, [](AsyncWebServerRequest *request) {
        AsyncResponseStream *response = request->beginResponseStream("text/plain");

        LOG_PORT.println("Driving roomba forward-right.");
        executeRoomba(RoombaCommand::FORWARDRIGHT);
        LOG_PORT.println("Finished driving roomba forward-right.");
